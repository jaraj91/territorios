...
FROM base as deploy
COPY --chown=www-data:www-data ./package.json ./package-lock.json ./postcss.config.js ./tailwind.config.js ./vite.config.js ./resources/css/app.css ./resources/js/app.js  /var/www/html/
